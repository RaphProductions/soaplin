...
char *ex_msgs[] = {"UNKNOWN", "KMODE_CPU_EXCEPTION"};
...
void panic(int cause, void *args) {
  ...
  tty_printf("or software. Disable BIOS memory options such as caching or "
             "shadowing.\n");
  tty_printf("If you need to use Safe Mode to remove or disable components, "
             "restart\n");
  tty_printf(
      "your computer, wait till the Limine boot menu appears, and then\n");
