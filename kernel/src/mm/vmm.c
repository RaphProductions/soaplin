...
void vmm_init()
{
	...
	/// We can't use vmm_create_pagemap, since it requires us to have the kernel pagemap, which we don't.
	...
	vmm_kernel_pagemap->vmaHead = (vma_region *)PHYSICAL_TO_VIRTUAL(pmm_allocpage());
